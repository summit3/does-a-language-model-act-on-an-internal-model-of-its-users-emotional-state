...
| `phase4/` | Steering: `phase4_steered.csv` (4,340 generations, runs A-N), `phase4_scores.csv` (rule scores), rate/CI tables per run, `phase4_keyword_lists.json`, `F5`-`F8`, reading sets `phase4_sample_for_reading.md` and `phase4_handcheck_set.md` | `scripts/04_steer.py` (pod), `04b_score_phase4.py`, `07_render_F9.py` (F9) and `08_render_T1.py` (`figures/T1_*.png`), both from `phase4_J_power_ci_v1_v2_v3.csv`; `10_render_T5.py` (`figures/T5_*.png`, from `phase4_M_sampled_subtraction_ci.csv`), `11_render_T6.py` (`figures/T6_*.png`, runs D/E/F/I/K/N rates from `phase4_scores.csv`) |
