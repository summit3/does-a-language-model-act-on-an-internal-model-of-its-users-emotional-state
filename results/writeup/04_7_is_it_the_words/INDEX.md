...
- `F1_v1_confounded_probe_acc_by_layer_task_a.png` <- `results/phase3/F1_v1_confounded_probe_acc_by_layer_task_a.png`: v1, before panel only
- `F4_v1_confounded_probe_direction_cosines.png` <- `results/phase3/F4_v1_confounded_probe_direction_cosines.png`: v1, before panel only
